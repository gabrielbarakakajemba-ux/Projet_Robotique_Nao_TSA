...
try:
    ...
    print("Configuration chargée avec succes !")
except ImportError as e:
    print("Toujours impossible de trouver config.python_paths : " + str(e))
...
def launch_scenario():
    ...
    base_path = os.path.join("modules", "behaviors", "autism_scenarios")
...
def launch_nao_game():
    ...
    """
    base_path = os.path.join("modules", "behaviors", "games")
...
def launch_motion_control():
    ...
    while True:
        ...
        if choix == "1":
            script = os.path.join("modules", "action", "motion", "robot_motion_controller.py")
        elif choix == "2":
            # Lancer le script Python 3 (vision)
            script_py3 = os.path.join("modules", "perception", "vision", "object_detection", "nao_object_detection.py")
            ...
            script_py2 = os.path.join("modules", "perception", "vision", "nao_video_stream_publisher_motion.py")
...
def launch_intelligent_vision_robot():
    ...
    """
    llm_server   = os.path.join("modules", "action", "speech_generation", "llm_server.py")
    face_server  = os.path.join("modules", "perception", "vision", "main.py")
    video_stream = os.path.join("modules", "perception", "vision", "nao_video_stream_publisher_vision.py")
    chatbot      = os.path.join("modules", "action", "speech_generation", "nao_chatbot.py")

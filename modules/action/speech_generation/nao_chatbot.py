...
try:
    ...
    print(u"ERREUR : Impossible de trouver config/python_paths.py")

try:
    import qi
except ImportError:
    print(u"ERREUR : Le module naoqi/qi est toujours introuvable.")
    print(u"Verifie le chemin dans python_paths.py : " + str(NAOQI_LIB_PATH))
